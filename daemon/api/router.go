...
func NewRouter(h *Handlers, static http.Handler) http.Handler {
	...
	r.Route("/api", func(api chi.Router) {
		...
		api.Group(func(authed chi.Router) {
			...
			authed.Delete("/integrations/{name}", h.DeleteIntegration)
			authed.Post("/integrations/{name}/test", h.TestIntegration)
		...
		api.Group(func(longAuthed chi.Router) {
			...
			longAuthed.Post("/discs/{id}/scan", h.ScanDisc)
			longAuthed.Post("/discs/{id}/type", h.SetDiscType)
